...
public:
    ...
    Executor(Goldilocks &fr, const Config &config, PoseidonGoldilocks &poseidon) :
        ...
        {
            zkassertpermanent(mainExecutor_fork_12.romBatch_12.constants.MAX_CNT_ARITH_LIMIT == arithExecutor.maxInputs);
            zkassertpermanent(mainExecutor_fork_12.romBatch_12.constants.MAX_CNT_BINARY_LIMIT == binaryExecutor.maxInputs);
            zkassertpermanent(mainExecutor_fork_12.romBatch_12.constants.MAX_CNT_KECCAK_F_LIMIT == paddingKKExecutor.maxInputs);
            zkassertpermanent(mainExecutor_fork_12.romBatch_12.constants.MAX_CNT_MEM_ALIGN_LIMIT == memAlignExecutor.maxInputs);
            zkassertpermanent(mainExecutor_fork_12.romBatch_12.constants.MAX_CNT_PADDING_PG_LIMIT == paddingPGExecutor.maxInputs);
            zkassertpermanent(mainExecutor_fork_12.romBatch_12.constants.MAX_CNT_POSEIDON_G_LIMIT == poseidonGExecutor.maxInputs);
            zkassertpermanent(mainExecutor_fork_12.romBatch_12.constants.MAX_CNT_SHA256_F_LIMIT == paddingSha256Executor.maxInputs);
        };
